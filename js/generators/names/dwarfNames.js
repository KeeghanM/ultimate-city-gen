...
function GenerateDwarfName(type) {
  names = ""
  if (type == 1) {
    let rnd = (Math.random() * nm3.length) | 0
    let rnd2 = (Math.random() * nm4.length) | 0
    names = nm3[rnd] + nm4[rnd2]
  } else {
    let rnd = (Math.random() * nm1.length) | 0
    let rnd2 = (Math.random() * nm2.length) | 0
    let rand = Math.random()
    names = random < 0.5 ? nm1[rnd] : nm2[rnd2]
  }
  return (names += " " + nameSur())
}
function nameSur() {
  let surname = ""
  let nTp = (Math.random() * 2) | 0
  let rnd = (Math.random() * nm5.length) | 0
  let rnd2 = (Math.random() * nm6.length) | 0
  let rnd3 = (Math.random() * nm7.length) | 0
  let rnd4 = (Math.random() * nm10.length) | 0
  let rnd5 = (Math.random() * nm11.length) | 0
  if (nTp === 0) {
